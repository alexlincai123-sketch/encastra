...
| 1 | Monorepo, tooling, CI skeleton | 🔨 in progress |
| 2 | Design system + visual language | ⬜ |
| 3 | Desktop shell (Tauri) boots and holds a window | ⬜ |
| 4 | Component engine: manifest → registry → instantiation | ⬜ |
| 5 | Canvas: place, connect, type-check, save | ⬜ |
| 6 | Runtime: RUN / STOP, journal, debugger | ⬜ |
| 7 | Projects + native versioning | ⬜ |
| 8 | Capability broker + consent UI + Security Center | ⬜ |
